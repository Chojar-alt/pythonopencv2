...
#  l2 = Label(window, text=file_path2).pack()
  ...
  b1 = Button(window, text = "Pierwsze zdjecie", command = file_path).pack()
  b2 = Button(window, text = "Drugie zdjecie", command = file_path2).pack()
  b3 = Button(window, text = "Pokaz efekt", command = cv2.imshow(image)).pack()
